...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_602f8cce2eee24_42577260',
...
function content_602f8cce2eee24_42577260 (Smarty_Internal_Template $_smarty_tpl) {
?><div id="_desktop_user_info">
	<div class="user-info-block selector-block">
		<div class="currency-selector localiz_block dropdown js-dropdown">
			<button data-target="#" data-toggle="dropdown" class=" btn-unstyle hidden-md-down">
                            <?php if ($_smarty_tpl->tpl_vars['logged']->value) {?>
                                <span class="expand-more"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customer']->value['firstname'], ENT_QUOTES, 'UTF-8');?>
</span>
                                <?php } else { ?>
			  <span class="expand-more"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Espace Client','d'=>'Shop.Theme.Customeraccount'),$_smarty_tpl ) );?>
</span>
                          <?php }?>
...
" rel="nofollow" class="dropdown-item"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Mon compte','d'=>'Shop.Theme.Customeraccount'),$_smarty_tpl ) );?>
</a>
			</li>
			<li>
			<li>
