			...
			{/if}	
				<div class="list-categories">
					...
					<div class="desc-listcategoreis">		
						<div class="name_categories" title="{$category.category_name}">
						...
						<div class="view-more"><a href="{$link->getCategoryLink($category['id_category'])}" target="_blank">{l s='View more' mod='poslistcategories'}</a> </div>
