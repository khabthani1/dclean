        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					$slide->description[$language['id_lang']] = '{"1":{"title":"Hight & Quality","display":"3","animation":"6"},"2":{"title":"The Parts Of","display":"0","animation":"7"},"3":{"title":"Shock Absorbers","display":"0","animation":"8"},"4":{"title":"& Brake Kit","display":"0","animation":"9"},"5":{"title":"Shop Now","display":"5","animation":"10"}}';
				}elseif($i==2){
					$slide->title = 'slide show2';
					$slide->cap_position = 1;
					$slide->description[$language['id_lang']] = '{"1":{"title":"Special offers","display":"3","animation":"8"},"2":{"title":"Get $250 Total","display":"0","animation":"9"},"3":{"title":"Discounts On","display":"0","animation":"7"},"4":{"title":"A New Tires","display":"0","animation":"6"},"5":{"title":"Shop Now","display":"5","animation":"10"}}';
				}else{
