...
class Postabproductslider extends Module {
	...
	public function install() {
		...
		Configuration::updateValue('POS_HOME_PRODUCTTAB_NEW', 0);
        ...
        Configuration::updateValue('POS_HOME_PRODUCTTAB_LIMIT', 12);
      ...
      public function uninstall() {
		...
		Configuration::deleteByName('POS_HOME_PRODUCTTAB_SALE');
		Configuration::deleteByName('POS_HOME_PRODUCTTAB_NEW');
		Configuration::deleteByName('POS_HOME_PRODUCTTAB_FEATURE');
		Configuration::deleteByName('POS_HOME_PRODUCTTAB_SELLER');
        Configuration::deleteByName('POS_HOME_PRODUCTTAB_RANDOMIZE');
        Configuration::deleteByName('POS_HOME_PRODUCTTAB_SPEED');
        Configuration::deleteByName('POS_HOME_PRODUCTTAB_LIMIT');
        Configuration::deleteByName('POS_HOME_PRODUCTTAB_NAV', true);
        Configuration::deleteByName('POS_HOME_PRODUCTTAB_PAGINATION');
        Configuration::deleteByName('POS_HOME_PRODUCTTAB_ITEMS');
        Configuration::deleteByName('POS_HOME_PRODUCTTAB_ROWS');
    		...
    		Media::addJsDef(
	            array(
	                'POS_HOME_PRODUCTTAB_ITEMS' => $config['POS_HOME_PRODUCTTAB_ITEMS'],
	                 ...
	                 'POS_HOME_PRODUCTTAB_LIMIT' => $config['POS_HOME_PRODUCTTAB_LIMIT'],
	 ...
	 protected function getBestSellers()
    {
        ...
        $nb = Configuration::get('POS_HOME_PRODUCTTAB_LIMIT');
    ...
    private function _postProcess() {
				...
				Configuration::updateValue('POS_HOME_PRODUCTTAB_LIMIT', Tools::getValue('POS_HOME_PRODUCTTAB_LIMIT'));
			...
			'form' => array(
				...
				'input' => array(
					...
					array(
                        'type' => 'text',
                        'label' => $this->l('Limit'),
                        'name' => 'POS_HOME_PRODUCTTAB_LIMIT',
                        'class' => 'fixed-width-xs',
                        'desc' => $this->l(''),
                    ),array(
                        'type' => 'text',
	...
	public function getConfigFieldsValues()
    {
        return array(
            ...
            'POS_HOME_PRODUCTTAB_LIMIT' => Tools::getValue('POS_HOME_PRODUCTTAB_LIMIT', (int) Configuration::get('POS_HOME_PRODUCTTAB_LIMIT')),
